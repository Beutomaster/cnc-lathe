...
#define SPI_BYTE_ARDUINO_MSG_RPM_H (3+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_RPM_L (4+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_X_H (5+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_X_L (6+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_Z_H (7+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_Z_L (8+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_F_H (9+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_F_L (10+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_H_H (11+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_H_L (12+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_T (13+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_N_H (14+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_N_L (15+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_ERROR_NO (16+SPI_BYTE_LENGTH_PRAEAMBEL)
#define SPI_BYTE_ARDUINO_MSG_CRC8 (17+SPI_BYTE_LENGTH_PRAEAMBEL)
